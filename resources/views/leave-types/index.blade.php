    ...
    <div class="container">
        <div class="row">
            ...
            {{-- <div class="col-6 text-end mb-3">
                <a class="btn btn-primary" href="{{ route('leave-type.create') }}"><i
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="font-weight-bold">ประเภทการลา</th>
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="{{ route('leave-type.show', $item->id) }}">
                                            <i class="fa fa-eye mr-1" aria-hidden="true"></i>{{ __('actions.view') }}
                                        </a>
                                        <a class="dropdown-item" href="{{ route('leave-type.edit', $item->id) }}">
